            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final listp3 = _model.listSt.toList();
                      return ListView.builder(
                        padding: EdgeInsets.zero,
                        primary: false,
                        shrinkWrap: true,
                        scrollDirection: Axis.vertical,
                        itemCount: listp3.length,
                        itemBuilder: (context, listp3Index) {
                          final listp3Item = listp3[listp3Index];
                          return Padding(
